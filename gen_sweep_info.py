...
def add_sweep_info(nusc, sample_infos):
    ...
    for curr_id in tqdm.tqdm(range(len(sample_infos['infos']))):
        token = sample_infos['infos'][curr_id]['token']
        ...
        sample_infos['infos'][curr_id]['occ_file'] = occ_file
        # add prev and next
        sample_infos['infos'][curr_id]['prev'] = sample['prev']
        sample_infos['infos'][curr_id]['next'] = sample['next']
