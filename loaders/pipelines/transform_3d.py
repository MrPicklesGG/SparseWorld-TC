...
class RandomScaleImageMultiViewImage(object):
    ...
    def __init__(self, scales=[], keepWH=False):
        self.scales = scales
        self.keepWH = keepWH
    ...
    def __call__(self, results):
        ...
        if self.keepWH == True:
            ...
            rand_scale = np.random.choice(self.scales)  # 0.5
            ...
            w_size = 704
            h_size = 256
            results['img'] = [mmcv.imresize(img, (w_size, h_size), return_scale=False) for img in results['img']]
